...
import profilePic from '../assets/FARDDIN.png'; // Adjust the path as necessary
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mt-8 md:mt-0">
        {/* Profile Picture */}
        <div className="w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-90 overflow-hidden rounded-full mr-6 sm:mr-0 sm:mb-6">
          <img
            src={profilePic}
            alt="Farddin"
            loading="lazy"
            onError={(e) => {
              e.target.src = '../assets/FARDDIN.png'; 
            }}
        ...
        <div className="flex flex-col space-y-4">
          <a href="https://www.linkedin.com/in/Farddinkhan/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-300 hover:text-green-500 transition hover:scale-110">
            <FaLinkedin size={24} />
          </a>
          <a href="https://github.com/farddinkhan730" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-300 hover:text-green-500 transition hover:scale-110">
            <FaGithub size={24} />
          </a>
        </div>
      </div>
